    ...
    fn paint_axis(&self, ui: &Ui, axis: usize, shapes: &mut Vec<Shape>) {
        ...
        for i in 0.. {
...

            {
                ...
                for i in 0..n {
                    let color = if i == 0 && value_main == 0.0 {
                        Color32::from_gray(120).additive()
                    } else if i == 0 {
                        Color32::from_gray(60).additive()
                    } else {
                        Color32::from_gray(25).additive()
                    };
            ...
            shapes.push(Shape::Text {
                ...
                galley,
                text_style,
                color: Color32::from_gray(150).additive(),
                fake_italics: false,
            });
        }
    }
